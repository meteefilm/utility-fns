...
const excelSheetFromDataSet = (dataSet) => {
    ...
    dataSet.forEach(dataSetItem => {
        ...
        rowCount += ySteps;
        var columnsWidth = []
        if (dataSetItem.page === "ADM15001") {
            columnsWidth = [{ wpx: 50 }, { wpx: 120 }, { wpx: 200 }, { wpx: 140 }, { wpx: 200 }, { wpx: 180 }, { wpx: 70 }]
        }
        // var columnsWidth = []
...
export { strToArrBuffer, dateToNumber, excelSheetFromDataSet };